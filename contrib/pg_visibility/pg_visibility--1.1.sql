...
CREATE FUNCTION pg_visibility_map_summary(regclass,
    OUT nblocks bigint, OUT all_visible bigint, OUT all_frozen bigint)
RETURNS record
AS 'MODULE_PATHNAME', 'pg_visibility_map_summary'
LANGUAGE C STRICT;

CREATE FUNCTION pg_visibility_map_summary2(regclass,
    OUT nblocks bigint, OUT all_visible bigint, OUT all_frozen bigint)
RETURNS record
AS 'MODULE_PATHNAME', 'pg_visibility_map_summary2'
LANGUAGE C STRICT;

CREATE FUNCTION pg_visibility_map_summaries(regclass, regclass, regclass, regclass,
    OUT pgbench_accounts_all_visible bigint, OUT pgbench_accounts_all_frozen bigint,
    OUT pgbench_branches_all_visible bigint, OUT pgbench_branches_all_frozen bigint,
    OUT pgbench_history_all_visible bigint, OUT pgbench_history_all_frozen bigint,
    OUT pgbench_tellers_all_visible bigint, OUT pgbench_tellers_all_frozen bigint)
RETURNS record
AS 'MODULE_PATHNAME', 'pg_visibility_map_summaries'
LANGUAGE C STRICT;
