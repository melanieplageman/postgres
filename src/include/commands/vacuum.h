...
struct VacuumCutoffs
{
	 ...
	 * target_freeze_duration. This is calculated using table stats about early
	 * page modifications and refreshed every
	 * REFRESH_UNFREEZE_STATS_EVERY_PAGES during vacuum.
	 */
	NormalDistribution early_unfreezes;

	/*
	 * The GUC target_freeze_duration translated from a time duration to an LSN
	 * duration. This is fetched from WAL stats every
	 * REFRESH_UNFREEZE_STATS_EVERY_PAGES during vacuum.
	 */
