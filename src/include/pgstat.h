...
typedef enum
{
	...
	WAIT_EVENT_HASH_INNER_VALIDATION_ELECT,
	WAIT_EVENT_HASH_INNER_VALIDATION_DIFF,
	WAIT_EVENT_HASH_OUTER_VALIDATION_ELECT,
	WAIT_EVENT_HASH_OUTER_VALIDATION_DIFF,
