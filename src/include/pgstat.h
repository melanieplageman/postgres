 ...
 * Once the LSNTimeStream length == volume (the array is full), old elements are
...
extern void pgstat_wal_update_lsn_time_stream(TimestampTz time, XLogRecPtr lsn);
