...
typedef struct PruneFreezeResult
{
	 ...
	 * doing an FPI.
	 * Some tuples were freezable but none older than freeze min age
	 * No tuples older than freeze min age.
	 */
	 ...
	 * of course, the page is not set frozen.
	 * No tuples older than freeze min age;
	 * Page not set frozen in VM
	 */
	 ...
	 * Some tuples older than freeze min age
	 * But page not set frozen in VM
	 */
