...
typedef struct TableAmRoutine
{
	 ...
	 * table_beginscan_bm(). Return false if the relation is exhausted and true
	 * otherwise.
	 *
	 ...
	 * for the benefit of scan_bitmap_next_tuple(). All AMs must set `recheck`,
	 * passed in by the caller, based on the value in the TBMIterateResult so
	 * that BitmapHeapNext() can determine whether or not to yield tuples.
	 *
