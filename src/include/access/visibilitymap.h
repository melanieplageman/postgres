...
extern bool visibilitymap_clear_and_lock(Relation rel, BlockNumber heapBlk,
										 Buffer vmbuf, uint8 flags);
...
extern bool visibilitymap_set_and_lock(Relation rel, BlockNumber heapBlk, Buffer heapBuf,
									   Buffer vmBuf, uint8 flags);
