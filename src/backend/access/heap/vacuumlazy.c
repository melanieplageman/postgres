				...
				bool *hastup)
{
	...
	*hastup = false;
	 ...
	 * all_visible. Keep track of whether or not the page is all_frozen and
	 * use this information to update the VM. all_visible implies lpdead_items
	 * == 0, but don't trust all_frozen result unless all_visible is also set
	 * to true.
	 */
	all_frozen = true;
	...
	Assert(!presult.all_visible || lpdead_items == 0);
