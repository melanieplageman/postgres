...
lazy_scan_heap(LVRelState *vacrel)
{
	...
	for (; blkno < rel_pages; blkno = next_blkno)
	{
		...
		Assert(!presult.page_all_visible || !has_lpdead_items);
				...
				PruneResult *presult)
{
	 ...
	 */
	tuples_deleted = heap_page_prune(rel, buf, vmbuffer, vmbits,
									 false, pronto_reap,
