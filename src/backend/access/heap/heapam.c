 ...
 * Caller passes an array of tuple plans from heap_prepare_freeze_tuple. Caller
 * must set 'offset' in each plan for us.
 */
void
				  ...
				  TransactionId FreezeLimit, TransactionId MultiXactCutoff)
{
	...
	do_freeze = heap_prepare_freeze_tuple(tuple, &pagefrz,
										  &frz, &totally_frozen);
