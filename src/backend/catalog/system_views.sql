...
CREATE VIEW pg_stat_all_tables AS
    SELECT
            ...
            pg_stat_get_eager_scan_hit_fail_threshold(C.oid) AS eager_scanned_hit_fail_threshold,
            pg_stat_get_eager_scan_hit_success_threshold(C.oid) AS eager_scanned_hit_success_threshold,
            ...
            pg_stat_get_oldest_unfrozen_xid_last_vacuum(C.oid) AS oldest_unfrozen_xid_last_vacuum
