...
CREATE VIEW pg_stat_all_tables AS
    SELECT
            ...
            pg_stat_get_eager_scanned_pages(C.oid) AS eager_scanned_pages,
            pg_stat_get_agg_scanned_av_pages(C.oid) AS agg_scanned_av_pages,
            pg_stat_get_skip_thresh_pages_scanned(C.oid) AS skip_thresh_pages_scanned,
