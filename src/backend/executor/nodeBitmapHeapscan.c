							...
							ParallelContext *pcxt)
{
	...
	/*
	 * Initialize the mutex, state, and condition variable only when
	 * parallel_aware.  These fields coordinate shared TBM iteration among
	 * parallel workers and are unused for non-parallel-aware scans.
	 */
