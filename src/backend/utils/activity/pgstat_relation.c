					 ...
					 BlockNumber scanned_pages)
{
	...
	tabentry->eager_scanned_pages += eager_scanned_pages;
	tabentry->pages_with_tuples_frozen += pages_with_tuples_frozen;
	tabentry->skip_thresh_pages_scanned += skip_thresh_pages_scanned;
	...
	tabentry->agg_scanned_av_pages += agg_scanned_av_pages;
